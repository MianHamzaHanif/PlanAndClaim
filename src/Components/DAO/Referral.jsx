            ...
            <div className="container-fluid px-md-3">
                <div className="row g-4">
                    <div className="col-12">
                        <div className="Heading">Referral Pool<span><i className="fa-solid fa-circle-question"></i></span></div>
                    </div>
                    ...
                    <div className="col-md-6">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-center justify-content-between mb-4">
                                    <div className="card-left-heading">10-Gen Level Members</div>
                                    <div className="right_amount">0 Members</div>
                                </div>
                            </div>
                        </div>
                    </div>
